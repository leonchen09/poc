...
public class Html2MHTCompiler {
	 ...
	 * <br>
	 * 方法说明：mht转html <br>
	 * 输入参数：strMht mht文件路径; strHtml html文件路径 <br>
	 * 返回类型：
	 */
	 ...
	 * <br>
	 * 方法说明：得到资源文件的name <br>
	 * 输入参数：strName 资源文件链接, ID 资源文件的序号 <br>
	 * 返回类型：资源文件的本地临时文件名
	 */
	 ...
	 * <br>
	 * 方法说明：得到网页编码 <br>
	 * 输入参数：bp MimeBodyPart类型的网页内容 <br>
	 ...
	 * <br>
	 * 方法说明：保存资源文件 <br>
	 * 输入参数：resources 要创建的资源文件; inputStream 要输入文件中的流 <br>
	 * 返回类型：boolean
	 */
	 ...
	 * <br>
	 * 方法说明：得到html文本 <br>
	 * 输入参数：bp MimeBodyPart类型的网页内容; strEncoding 内容编码 <br>
	 * 返回类型：html文本
	 */
	 ...
	 * <br>
	 * 方法说明：保存html文件 <br>
	 * 输入参数：strText html内容; strHtml html文件名 <br>
	 * 返回类型：
	 */
