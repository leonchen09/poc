 ...
 */
@ApiModel(value="修改主从机ID发送表查询",description="修改主从机ID发送表查询描述")
public class SearchModifyGprsidSendPagingVo extends PageEntity {
    /**
     ...
     */
    @ApiModelProperty(value="0为待发送,1为发送,2为修改成功,3为修改失败",required=false)
