...
{
    public partial class ButtonDropDown : Button
    {
        #region Fields
        ...
        /// Context Menu Left
        /// </summary>
        [Description("Indicates left of Context Menu")]
        [DefaultValue(0)]
        public int ContextMenuLeft
        {
            get
            {
                return _ContextMenuLeft;
            }
            set
            {
                _ContextMenuLeft = value;
            }
        }


        [Description("Indicates top of Context Menu")]
        [DefaultValue(0)]
        public int ContextMenuTop
        {
            get
            {
                return _ContextMenuTop;
            }
            set
            {
                _ContextMenuTop = value;
            }
        }
        ...
        private void InitDefaultSplitImages(bool refresh)
        {
            ...
            if (_DefaultSplitImages.Images.Count == 0 || refresh)
            {
                ...
                try
                {
                    ...
                    g.FillPolygon(fBrush, new Point[] { new Point(mw - 1, mh - 3), 
                                                         new Point(mw -1, mh + 3),
                                                         new Point(mw +2, mh) });
                    ...
                    g.FillPolygon(fBrush, new Point[] { new Point(mw - 2, mh - 5), 
                                                         new Point(mw -2 , mh + 5),
                                                         new Point(mw + 3, mh ) });
        ...
        {           
            ...
            if (_AlwaysDropDown || _AlwaysHoverChange || MouseInSplit())
            {
                if (Enabled)
                {
                    ...
                    {
                        this.ContextMenu.Show(this, new Point(_ContextMenuLeft, _ContextMenuTop));
                    }
                }
            }
            else
