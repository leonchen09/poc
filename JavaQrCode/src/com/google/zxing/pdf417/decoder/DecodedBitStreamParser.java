...
final class DecodedBitStreamParser {
  ...
  private static int decodeMacroBlock(int[] codewords, int codeIndex, PDF417ResultMetadata resultMetadata)
    ...
    if (codewords[codeIndex] == BEGIN_MACRO_PDF417_OPTIONAL_FIELD) {
      ...
      int[] optionalData = new int[additionalOptionCodeWordsIndex];
      System.arraycopy(additionalOptionCodeWords, 0, optionalData, 0, additionalOptionCodeWordsIndex);
      resultMetadata.setOptionalData(optionalData);
